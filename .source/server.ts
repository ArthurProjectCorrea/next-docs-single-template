...
export const docs = await create.docs(
  ...
  {},
  {
    ...
    'introduction.mdx': __fd_glob_1,
    'API/index.mdx': __fd_glob_2,
    'API/introduction.mdx': __fd_glob_3,
    'API/upintroduction.mdx': __fd_glob_4,
    'Intro/index.mdx': __fd_glob_5,
    'Intro/introduction.mdx': __fd_glob_6,
    'Intro/kaintroduction.mdx': __fd_glob_7,
  },
);
